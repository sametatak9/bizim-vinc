...
export const DashboardPage: React.FC<DashboardPageProps> = ({ onNavigate }) => {
  ...
  return (
    <main className="space-y-6 animate-in fade-in duration-150" id="dashboard-page">
      <section className="relative overflow-hidden rounded-[28px] text-white p-6 sm:p-8 shadow-xl" style={{ background: 'linear-gradient(135deg, #052e1c 0%, var(--brand-green-700) 55%, var(--brand-green-600) 100%)' }}>
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-7">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-emerald-50/80">Ödeme, tahsilat, çek & senet takibiyle başlayın — ardından filo, personel ve onay akışlarını yönlendirin.</p>
          </div>
