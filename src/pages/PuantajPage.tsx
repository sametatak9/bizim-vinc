...
}} className={`inline-flex w-5 h-5 items-center justify-center rounded-md font-black hover:scale-110 transition cursor-pointer ${cls}`}>{symbol}</button></td>; })}</tr>)}</tbody></table></div></div>
